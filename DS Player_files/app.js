...
function uiAdjustVKLayout() {
    ...
    $id('vk-menu').style = makeVKStyle(offTop + abxyHeight - vkh, window.innerWidth / 2 - vkw * 0.5, vkw, vkh, fontSize)
...
if (isIframed) {
    ...
    alert(`Attention! It looks like this page is being embedded into another website.

Please note that our site (ds.44670.org) is NOT affiliated with any other website you may be currently visiting, and we cannot guarantee the safety of your data if you are using this site in an embedded form.

This software is designed to be used as a standalone web app and may not work properly when embedded into another website.

If you want to continue using this software, please visit our website directly at https://ds.44670.org/`)
